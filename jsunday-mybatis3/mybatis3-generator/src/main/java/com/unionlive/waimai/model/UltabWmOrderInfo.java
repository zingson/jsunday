package com.unionlive.waimai.model;
...
public class UltabWmOrderInfo {
    ...
    private String shipperStatusText;
    ...
    public void setShipperStatus(String shipperStatus) {
        this.shipperStatus = shipperStatus == null ? null : shipperStatus.trim();
    }

    public String getShipperStatusText() {
        return shipperStatusText;
    }
